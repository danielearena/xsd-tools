...
def main():
    parser = argparse.ArgumentParser(description="Process and flatten XSD files.")
    parser.add_argument("main_xsd_file", help="Path to the main XSD file.")
    args = parser.parse_args()

    main_xsd_file = args.main_xsd_file
